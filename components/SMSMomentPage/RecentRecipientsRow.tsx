      ...
      <div className="flex flex-wrap gap-2">
        ...
        {moreCount > 0 && (
          <button
            type="button"
            onClick={openSearch}
            className="rounded-full border border-dashed border-grey-moss-200 px-3.5 py-1 font-archivo text-xs text-grey-moss-300 hover:border-grey-moss-900 hover:text-grey-moss-900"
          >
            +{moreCount} more
          </button>
        )}
